...
function sendNotification(user) {
  webPush
    .sendNotification({ endpoint: user.subscription })
    .then(() => {
...
app.use((req, res, next) => {
  res.set({
    'Access-Control-Allow-Origin': 'https://push-client-test.herokuapp.com',
...
app.post('/logout', (req, res) => {
  res.set('Access-Control-Allow-Origin', 'https://push-client-test.herokuapp.com');
  const index = users.findIndex(user => user.username === req.body.username);
